...
const Hero = () => {
  return (
    <div className="container">
      ...
      <div className="row p-5 mt-5 mb-5 border-top text-muted " style={{lineHeight:"1.5", fontSize:"1.2em"}}>
        <div className="row">
          ...
          <div className="col-6 p-5">
            ...
            <p>
              <a href="https://rainmatter.com/" target="_blank" className="text-decoration-none">Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.
              </p>
